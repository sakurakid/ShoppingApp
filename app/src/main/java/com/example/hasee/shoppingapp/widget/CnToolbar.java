...
//    }
    ...
    public void setUserPhotoIcon(Context context, int default_head) {
    }

    public void setUserPhotoIcontext(Context context , int resId){
        Glide.with(context).load(resId).into(this.userPhoto);
        userPhoto.setVisibility(VISIBLE);
        userPhoto.setEnabled(true);
    }
